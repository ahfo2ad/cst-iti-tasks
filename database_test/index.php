    ...
    <?php 
        ...
        if($do == "manage") { ?>
            ...
            <div class="container">
                ...
                <form  class="form-horizontal" action="?do=insert" method="POST" onsubmit="return false">
                <!-- <form  class="form-horizontal" action="" method="POST" onsubmit="return false"> -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 offset-sm-4">
                            <input type="submit" id="btnData" class="btn btn-primary form-control" value="Add">
                            <!-- <button type="button" id="btnData" class="btn btn-primary form-control">add</button> -->
                        </div>
                    </div>
                </form>
            </div>
